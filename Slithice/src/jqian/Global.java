...
public class Global {
	...
	private HeapAbstraction heapLocAbstraction;
	
	public void setHeapLocationAbstraction(HeapAbstraction locAbstraction){
		heapLocAbstraction = locAbstraction;
	}
	
	public HeapAbstraction getHeapLocationAbstraction(){
		return heapLocAbstraction;
	}	
